    ...
    <div className={isOpened ? styles.overlay : styles.overlayClosed}>
      <div className={styles.modal}>
        ...
        <div className={styles.center}>
          ...
          {/* Opciones rotadas */}
          <Link to="/explore" className={`${styles.option} ${styles.left}`}>
            EXPLORAR
          </Link>

          <Link to="/store" className={`${styles.option} ${styles.top}`}>
            TIENDA
          </Link>

          <Link to="/presale" className={`${styles.option} ${styles.right}`}>
            PRE-SALE
          </Link>

          <Link to="/artists" className={`${styles.option} ${styles.bottom}`}>
            ARTISTAS
          </Link>
        </div>
